...
2. Sett opp en maskinell jobb der du jevnlig kaller endepunktet `/endringslogg`. 
   ...
   3. Oppdater sekvensnummeret ditt til den siste endringens `id`. Da har du det nyeste sekvensnummeret, som kan brukes til å kalle `/endringslogg` igjen for å lytte på videre endringer.
