...
| **Registrering**                   |                                                    | Melding om nyregistrering eller endring av reelle rettighetshavere                                                                                             |
|                                    | registereringsid                                   | Unik identifikator for en bestemt registrering                                                                                                                 |
...
| **Posisjon**                       |                                                    |                                                                                                                                                                |
|                                    | posisjonstype                                      | En type kontroll eller eierskap over registreringspliktig i siste instans                                                                                      |
...
|                                    | beskrivelseAvPosisjonenKontrollPåAnnenMåte         | Tekstbeskrivelse av posisjon på annen måte                                                                                                                     |
